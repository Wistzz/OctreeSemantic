...
python render_lerf_by_text.py -m "./output/teatime1" --scene_name "teatime"
python render_lerf_by_text.py -m "./output/teatime1" --scene_name "teatime"
...
# python render_lerf_by_text.py -m "./output/figurines_sparse_infonce" --scene_name "figurines"
