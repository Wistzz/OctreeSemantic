...
# ============== [10 scenes] ==============
## 0140:150
## 0200:inf !!!!! Wrong transforms
## 0340:60
## 0400:inf !!!!! Wrong transforms
## 0590 15
## 0645 10
scan_list=("scene0347_00" "scene0400_00" "scene0590_00" "scene0645_00")
gpu_num=4     # change!
for scan in "${scan_list[@]}"; do
    echo "Training for ${scan} ....."
    CUDA_VISIBLE_DEVICES=$gpu_num python train.py --port 531$gpu_num \
